...
var I = (e2, t2) => {
  ...
  for (let e3 = 0; e3 < f2.length; e3++) {
    ...
    if ("if-needed" === i2 && x2 >= 0 && S2 >= 0 && N2 <= p2 && k2 <= m2 && x2 >= r3 && N2 <= u3 && S2 >= c3 && k2 <= s3)
      return j2;
    ...
    if (h2 === t3)
      R3 = "start" === l2 ? T2 : "end" === l2 ? T2 - p2 : "nearest" === l2 ? M(g2, g2 + p2, p2, y2, C2, g2 + T2, g2 + T2 + w2, w2) : T2 - p2 / 2, $3 = "start" === a2 ? W2 : "center" === a2 ? W2 - m2 / 2 : "end" === a2 ? W2 - m2 : M(b2, b2 + m2, m2, v3, E2, b2 + W2, b2 + W2 + I2, I2), R3 = Math.max(0, R3 + g2), $3 = Math.max(0, $3 + b2);
    else {
